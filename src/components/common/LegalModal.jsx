...
const LegalModal = ({ isOpen, onClose, type }) => {
  ...
  const contentMap = {
    'privacy': {
      ...
      sections: [
        { heading: '1. Information We Collect', text: 'At Susheela Upvan, we collect personal information such as your name, email address, shipping address, and phone number when you place an order for our farm products or subscribe to our newsletter.' },
        { heading: '2. How We Use Your Information', text: 'We use your data strictly to process your orders, schedule deliveries for fresh dairy and mushrooms, and send you important updates regarding your purchases.' },
    ...
    'terms': {
      ...
      lastUpdated: 'March 10, 2026',
      sections: [
        { heading: '1. Product Quality & Delivery', text: 'Susheela Upvan guarantees the delivery of fresh, natural farm products. Due to the perishable nature of dairy and mushrooms, customers must ensure someone is available to receive the delivery during the chosen time slot.' },
    ...
    'shipping': {
      ...
      lastUpdated: 'March 10, 2026',
      sections: [
        { heading: '1. Farm Fresh Promise', text: 'To ensure maximum freshness, our delivery team brings dairy and mushrooms directly from the farm to your doorstep in temperature-controlled packaging.' },
    ...
    'faq': {
      ...
      lastUpdated: 'March 10, 2026',
      sections: [
        { heading: 'Are your products organic?', text: 'Yes, our mushrooms are grown without synthetic chemicals, and our dairy comes from free-range cattle fed on natural pasture.' },
    ...
    'sitemap': {
      ...
      lastUpdated: 'March 10, 2026',
      sections: [
        { heading: 'Navigation', text: 'Home | Products | Dairy | Mushrooms | About Us | Gallery | Contact | Profile | Orders | Cart' }
      ]
    },
    'grievance-redressal': {
      icon: <Shield className="text-emerald-500 w-8 h-8" />,
      ...
      lastUpdated: 'March 10, 2026',
      sections: [
        { heading: '1. Grievance Officer', text: 'In accordance with consumer protection rules, our Grievance Officer can be reached at grievance@susheelaupvan.com.' },
    ...
    'epr-compliance': {
      ...
      lastUpdated: 'March 10, 2026',
      sections: [
        { heading: 'Extended Producer Responsibility', text: 'Susheela Upvan is committed to environmental sustainability. We comply with EPR framing regarding plastic waste management and encourage returning our glass bottles for reuse.' }
      ]
    },
    'fssai': {
      icon: <Shield className="text-emerald-500 w-8 h-8" />,
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 md:p-8 border-b border-slate-100 bg-slate-50/50 relative z-10 shrink-0">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center shadow-inner shrink-0">
                {content.icon}
              </div>
              <div>
            ...
            <div className="space-y-8 pr-2">
              <div className="prose prose-slate max-w-none">
                <p className="text-slate-500 text-sm leading-relaxed mb-6">
                  Please read these {content.title.toLowerCase()} carefully before using the Susheela Upvan platform.
                  Your continued use of our services constitutes acceptance of these terms.
                </p>
                
                <div className="space-y-6">
                  {content.sections.map((section, idx) => (
                    <div key={idx} className="bg-slate-50 p-5 rounded-2xl border border-slate-100/50 hover:bg-emerald-50/30 hover:border-emerald-100 transition-colors">
