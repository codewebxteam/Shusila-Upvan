    ...
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-12 py-4 lg:py-5 rounded-2xl border-2 border-slate-200 bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all duration-300 text-sm lg:text-base shadow-sm hover:shadow-md"
        />
      ...
      {showResults && searchResults.length > 0 && (
        <div className="absolute top-full left-0 right-0 mt-3 bg-white rounded-2xl shadow-lg border border-slate-200 z-50 max-h-96 overflow-y-auto">
            ...
            {searchResults.map((product) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-semibold text-slate-900 group-hover:text-green-600 transition-colors">
                    {product.name}
                  </h4>
          ...
          <div className="border-t border-slate-200 p-3 bg-slate-50 rounded-b-2xl">
            <button className="w-full text-center text-sm font-semibold text-green-600 hover:text-green-700 py-2 transition-colors">
