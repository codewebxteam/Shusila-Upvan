                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center gap-2 p-2 bg-slate-50 rounded-2xl border border-slate-100">
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all ${copied ? 'bg-emerald-600 text-white' : 'bg-slate-900 text-white hover:bg-emerald-600'
                                        }`}
                                >
