...
import { ShoppingBag, ArrowRight, Sprout, Milk } from 'lucide-react';
...
const CartView = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      <h3 className="text-3xl font-black text-slate-900 tracking-tighter italic mb-8">
        My Cart.
      </h3>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-emerald-600 uppercase mt-1 italic tracking-widest">
                  Qty: {item.quantity}
                </p>
              </div>
            </div>
      ...
      <div className="mt-8 pt-6 border-t border-slate-100">
        ...
        <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest italic">
          Free delivery in Khalilabad city limits
        </p>
      </div>
    </div>
  );
