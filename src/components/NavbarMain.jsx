  ...
  return (
    <>
      ...
      >
        ...
        {/* Center: Navigation Links (Desktop) WITH ICONS */}
        ...
        {/* Right Side: Auth + Cart (Desktop) WITH ICONS */}
        <div className="hidden md:flex items-center gap-6">
          ...
          {user ? (
            <div className="relative">
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-[#fdfbe9] border shadow-lg rounded-md py-2 z-50">
                  <NavLink 
                    to="/profile" 
                    onClick={closeMenu} 
            ...
            <div className="w-full px-4">
              ...
              {servicesOpen && (
                <div className="pl-8 mt-2 space-y-2">
                  ...
                  >
                    <Sprout size={16} /> Cultivation Support
                  </Link>
                  <Link
                    to="/mushrooms"
                    onClick={closeMenu}
                    className="flex items-center gap-2 text-sm text-gray-700 hover:text-[#95e500]"
                  >
                    <ShoppingBasket size={16} /> Buy Fresh Mushrooms
                  </Link>
                  <Link
                    to="/events"
                    onClick={closeMenu}
                    className="flex items-center gap-2 text-sm text-gray-700 hover:text-[#95e500]"
                  >
                    <Calendar size={16} /> Community Events
                  </Link>
                  <Link
                    to="/knowledge"
                    onClick={closeMenu}
                  ...
                  <Link
                    ...
                    className="flex items-center gap-2 text-sm text-gray-700 hover:text-[#95e500]"
                  >
                    <Users size={16} /> Farmer Community
                  </Link>
                  <Link
                    to="/contact"
                    onClick={closeMenu}
