    ...
    <footer className="relative overflow-hidden bg-slate-100/80 backdrop-blur-3xl text-slate-900 pt-[70px] pb-[40px] px-8 font-sans border-t-2 border-slate-200 flex justify-center w-full">
      <div className="w-full max-w-6xl relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-[60px] mb-12 w-full">
          <div className="col-span-1 md:col-span-1 flex flex-col gap-6">
            <h3
              ...
              onClick={() => navigate('/')}
            >
              Susheela<br /><span className="text-emerald-500">Upvan.</span>
            </h3>
          ...
          <div className="col-span-1 flex flex-col gap-6 md:pl-12">
            ...
            {['Home', 'About', 'Dairy', 'Mushroom'].map((item) => {
              ...
              return (
                <button
                  ...
                  className="text-[12px] font-black text-slate-600 uppercase tracking-widest hover:text-emerald-500 hover:pl-2 transition-all duration-300 text-left w-fit"
                >
                  {item}
                </button>
              );
        ...
        <div className="mt-16 pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6 text-[9px] text-slate-400 font-black tracking-[0.2em] uppercase">
          <p>© {new Date().getFullYear()} Susheela Upvan Lab. Systems Core v2.</p>
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2 text-emerald-500 bg-emerald-50 px-4 py-1.5 rounded-full border border-emerald-100 shadow-sm">
              <ShieldCheck size={12} />
