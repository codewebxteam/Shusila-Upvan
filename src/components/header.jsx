                ...
                <>
                  ...
                  <div className="flex min-[426px]:hidden items-center">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => openAuthModal('signup')}
                      className="px-2.5 sm:px-4 py-2 bg-gradient-to-r from-emerald-600 to-amber-500 text-white rounded-xl text-[9px] sm:text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-500/20"
                    >
                      Sign Up
                    </motion.button>
                  </div>
