...
const ProductList = () => {
  ...
  const products = [
    { id: 1, name: "Raw A2 Cow Milk", price: 85, img: milkImg, unit: "Litre", color: "from-blue-500/10", tag: "Fresh" },
    { id: 2, name: "Vedic Bilona Ghee", price: 1200, img: gheeImg, unit: "Kg", color: "from-amber-500/10", tag: "Premium" },
    { id: 3, name: "Natural Farm Curd", price: 60, img: curdImg, unit: "Kg", color: "from-emerald-500/10", tag: "Organic" }
  ];
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <motion.button
                  ...
                  className={`w-full py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 transition-all shadow-xl shadow-blue-100 ${addedItems[item.id]
