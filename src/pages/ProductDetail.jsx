                        ...
                        <div className="grid grid-cols-3 gap-4 mt-8">
                            {[
                                ...
                                <div key={i} className="text-center p-4 bg-white rounded-3xl border border-slate-100">
                                    <item.icon size={20} className="mx-auto text-emerald-600 mb-2" />
                        ...
                        <div className="space-y-6 max-w-md">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <motion.button
                                    ...
                                    className="flex-1 py-5 bg-emerald-600 text-white rounded-[2rem] text-[11px] font-black uppercase tracking-[0.2em] hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-500/20"
                                >
                                    Buy Now
                                </motion.button>
                            </div>
                                        ...
                                        {activeTab === 'highlights' && (
                                            <div className="flex flex-wrap gap-2">
                                                {(product.highlights || []).map((highlight, i) => (
                                                    <span key={i} className="px-4 py-2 bg-emerald-50 text-emerald-700 rounded-full text-[10px] font-black uppercase tracking-widest border border-emerald-100 flex items-center gap-2">
