                    ...
                    <div className="flex min-h-full items-center justify-center p-4">
                        ...
                        >
                            ...
                            <form className="space-y-4" onSubmit={handleSubmit}>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-3.5 pl-12 pr-4 text-sm font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
                                            />
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex justify-between items-center ml-4 mr-1">
                                        ...
                                        {view === 'login' && (
                                            <button type="button" className="text-[9px] font-black uppercase tracking-widest text-slate-400 hover:text-emerald-600 transition-colors">Forgot Password?</button>
                                        )}
                                    </div>
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            placeholder="••••••••"
                                            className="w-full bg-slate-50 border border-slate-100 rounded-2xl py-3.5 pl-12 pr-12 text-sm font-bold text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
                                        />
                                        <button
                                            type="button"
                                ...
                                <motion.button
                                    ...
                                    type="submit"
                                    disabled={isLoading}
                                    className={`w-full py-4 rounded-2xl bg-gradient-to-r from-emerald-600 to-amber-500 text-white font-black uppercase tracking-widest text-xs shadow-xl shadow-emerald-500/20 mt-2 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                                >
                            ...
                            <motion.button
                                ...
                                disabled={isLoading}
                                className={`w-full flex items-center justify-center gap-3 py-3.5 border border-emerald-600/30 rounded-2xl text-slate-900 text-sm font-bold transition-all ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                            >
                            ...
                            <div className="mt-8 text-center text-slate-400 text-xs font-semibold">
                                {view === 'login' ? (
                                    <>Don't have an account? <button onClick={() => setView('signup')} className="text-emerald-600 font-black hover:underline underline-offset-4">Sign Up</button></>
                                ) : (
                                    <>Already have an account? <button onClick={() => setView('login')} className="text-emerald-600 font-black hover:underline underline-offset-4">Login</button></>
                                )}
                            </div>
                        </motion.div>
                    </div>
