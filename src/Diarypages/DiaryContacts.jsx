      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        >
          ...
          <h2 className="text-lg md:text-xl font-medium mb-4 text-gray-700">
            Have Questions About Milk, Delivery, or Dairy Products?
          </h2>

          <p className="text-gray-600 mb-6 text-sm md:text-base">
            Reach out to us for any inquiries about milk supply, bulk orders, home delivery, or dairy product details.
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Write your query about milk supply, pricing, delivery schedule, or dairy services"
              rows="4"
              className="w-full border border-green-300 rounded-lg p-3 bg-white text-gray-900 focus:ring-2 focus:ring-green-500 transition"
              required
            />
            ...
            {status.success && (
              <p className="text-green-700 text-sm">{status.success}</p>
            )}
            {status.error && (
        ...
        >
          ...
          <div className="w-full space-y-5">
            <motion.div
              ...
              className="flex items-center gap-3 p-5 bg-green-50 rounded-xl shadow"
            >
              <FaEnvelope className="text-green-600 text-xl" />
              <div>
                <p className="font-semibold text-gray-900">Email</p>
                <p className="text-sm text-gray-700">support@milkdairy.com</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-700">+91 90000 12345</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <p className="font-semibold text-gray-900">Dairy Address</p>
                <p className="text-sm text-gray-700">
                  Shusila Upvan Milk Dairy, Main Road, Your City, India
                </p>
              </div>
            </motion.div>
          </div>
